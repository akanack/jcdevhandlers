<<<<<<< HEAD:devicetypes/jscgs350/fortrezz-flow-meter-interface.src/fortrezz-flow-meter-interface.groovy
/**
...
def configure() {
    ...
    log.debug "Configuration report for FortrezZ flow meter interface (FMI): '${cmds}'"
    cmds
>>>>>>> constjs/master:devicetypes/jscgs350/my-fortrezz-flow-meter-interface.src/my-fortrezz-flow-meter-interface.groovy
}