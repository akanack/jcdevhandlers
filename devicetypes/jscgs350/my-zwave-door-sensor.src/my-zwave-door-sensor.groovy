 ...
 *
 *  My Z-Wave Door Sensor Version: v2
 *
 *  Updates:
 *  -------
...
metadata {
	definition (name: "My Z-Wave Door Sensor", namespace: "jscgs350", author: "SmartThings") {
	...
	tiles(scale: 2) {
		multiAttributeTile(name:"contact", type: "generic", width: 6, height: 4){
			tileAttribute ("device.contact", key: "PRIMARY_CONTROL") {
				attributeState "closed", label: 'closed', icon: "st.nest.nest-home", backgroundColor: "#79b821"
				attributeState "open", label: 'open', icon: "st.nest.nest-away", backgroundColor: "#ffa81e"
			}
		}        
